  ...
  describe('filter', function() {
    describe('Boundary date at card sets and adventures', function() {
      ...
      function filterCardSet(dateString: string, name: CardSetName) {
        return filter(new Date(dateString), false).filter(cardSet => cardSet.name === name);
      }
    ...
    describe('Standard rule', function() {
      describe('with classic', function() {
        it('Before standard rule is enforced', function() {
          const cardSetNames = filter(new Date('2016-04-15'), false).map(cardSet => cardSet.name);
        ...
        describe('Year of the Kraken', function() {
          it('Release Whispers of the Old Gods', function() {
            const cardSetNames = filter(new Date('2016-04-16'), false).map(cardSet => cardSet.name);
            assert.deepStrictEqual(
              cardSetNames,
          ...
          it('Release One Night in Karazhan', function() {
            const cardSetNames = filter(new Date('2016-08-11'), false).map(cardSet => cardSet.name);
            assert.deepStrictEqual(
              cardSetNames,
          ...
          it('Release Mean Streets of Gadgetzan', function() {
            const cardSetNames = filter(new Date('2016-12-01'), false).map(cardSet => cardSet.name);
            assert.deepStrictEqual(
              cardSetNames,
        ...
        describe('Year of the Mammoth', function() {
          it('Release Journey to Un\'Goro', function() {
            const cardSetNames = filter(new Date('2017-04-07'), false).map(cardSet => cardSet.name);
            assert.deepStrictEqual(
              cardSetNames,
          ...
          it('Release Knights of the Frozen Throne', function() {
            const cardSetNames = filter(new Date('2017-08-11'), false).map(cardSet => cardSet.name);
            assert.deepStrictEqual(
              cardSetNames,
          ...
          it('Release Kobolds & Catacombs', function() {
            const cardSetNames = filter(new Date('2017-12-07'), false).map(cardSet => cardSet.name);
            assert.deepStrictEqual(
              cardSetNames,
        ...
        describe('Year of the Raven', function() {
          it('Release Witchwood', function() {
            const cardSetNames = filter(new Date('2018-04-12'), false).map(cardSet => cardSet.name);
            assert.deepStrictEqual(
              cardSetNames,
          ...
          it('Release The Boomsday Project', function() {
            const cardSetNames = filter(new Date('2018-08-07'), false).map(cardSet => cardSet.name);
            assert.deepStrictEqual(
              cardSetNames,
      ...
      describe('without classic', function() {
        it('Before standard rule is enforced', function() {
          const cardSetNames = filter(new Date('2016-04-15'), true).map(cardSet => cardSet.name);
          assert.deepStrictEqual(
            cardSetNames,
        ...
        describe('Year of the Kraken', function() {
          it('Release Whispers of the Old Gods', function() {
            const cardSetNames = filter(new Date('2016-04-16'), true).map(cardSet => cardSet.name);
            assert.deepStrictEqual(
              cardSetNames,
              ['BRM', 'TGT', 'LOE', 'OG'],
            );
          ...
          it('Release One Night in Karazhan', function() {
            const cardSetNames = filter(new Date('2016-08-11'), true).map(cardSet => cardSet.name);
            assert.deepStrictEqual(
              cardSetNames,
              ['BRM', 'TGT', 'LOE', 'OG', 'KARA'],
            );
          ...
          it('Release Mean Streets of Gadgetzan', function() {
            const cardSetNames = filter(new Date('2016-12-01'), true).map(cardSet => cardSet.name);
            assert.deepStrictEqual(
              cardSetNames,
        ...
        describe('Year of the Mammoth', function() {
          it('Release Journey to Un\'Goro', function() {
            const cardSetNames = filter(new Date('2017-04-07'), true).map(cardSet => cardSet.name);
            assert.deepStrictEqual(
              cardSetNames,
          ...
          it('Release Knights of the Frozen Throne', function() {
            const cardSetNames = filter(new Date('2017-08-11'), true).map(cardSet => cardSet.name);
            assert.deepStrictEqual(
              cardSetNames,
          ...
          it('Release Kobolds & Catacombs', function() {
            const cardSetNames = filter(new Date('2017-12-07'), true).map(cardSet => cardSet.name);
            assert.deepStrictEqual(
              cardSetNames,
        ...
        describe('Year of the Raven', function() {
          it('Release Witchwood', function() {
            const cardSetNames = filter(new Date('2018-04-12'), true).map(cardSet => cardSet.name);
            assert.deepStrictEqual(
              cardSetNames,
          ...
          it('Release The Boomsday Project', function() {
            const cardSetNames = filter(new Date('2018-08-07'), true).map(cardSet => cardSet.name);
            assert.deepStrictEqual(
              cardSetNames,
